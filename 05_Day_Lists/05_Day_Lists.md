<div align="center">
  <h1> 30_Days_Of_Python: 05_Day_Lists</h1>
...
[<< Day 4](../04_Day_Strings/04_Day_Strings.md) | [Day 6 >>](../06_Day_Tuples/06_Day_Tuples.md)
...
- [Day_05](#day-5)
  ...
  - [💻 Exercises: Day_05](#-exercises-day-5)
...
```py
 lst = ['Kien Duong', 20, True, {'country':'Vietnam', 'city':'Ho Chi Minh City'}] # list containing different data types
```
